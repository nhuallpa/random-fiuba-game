...
void MissileBananita2d::explode( ){
}
...
void MissileBanana2d::animate( float time ){
...
MissileBananita2d::MissileBananita2d(ElementType type, float posX, float posY, float angle_x, float angle_y, float fuerzaDisparo, b2World *myWorld, GameElement *modelElement){
...
void MissileBananita2d::animate( float time ){
