...
DataBmp24::DataBmp24(unsigned char* data,int row_padded, int height,int width):DataBmp(data,row_padded,height,width)
{
...
void DataBmp24::loadMatrix(unsigned char* data,int row_padded, int height,int width)
{
    unsigned char tmp;
